...
<body>
   ...
   <nav class="navbar">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div>
                <a href="/beranda" class="hover:text-blue-500"><i class="fas fa-home"></i> Beranda</a>
                <a href="/diagnosa" class="hover:text-blue-500"><i class="fas fa-diagnoses"></i> Diagnosa</a>
            </div>
        </div>
    </nav>
